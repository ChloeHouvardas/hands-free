...
- Answer first, in a sentence or two. Expand only if asked.
- No preamble, no recapping what you just did, no commentary on paths not taken.
- Clarify with me before architectural or hard-to-reverse tech decisions
  (inference runtime, model, HID approach, language). Small utility libraries
